...
/*
    Events Map Page Component

    Responsibilities:
    - Render a map showing event locations
    - Provide navigation to create event and event details
    - Handle user logout
    ...
    Outputs:
    - Renders the events map UI
    - Updates authentication context on logout
*/
...
export default function EventsMap(props: StackScreenProps<any>) {
  ...
  /*
    ...
    Responsibilities:
    - Clear cached user info and access token
    - Update authentication context to undefined
    ...
    Outputs:
    - User is logged out and navigated to Login page
  */
...
/*
    ...
    Responsibilities:
    - Define the structure of an event object used in the map
    
    Inputs:
    - id: Unique identifier for the event
    - position: Latitude and longitude coordinates of the event

    Outputs:
    - event objects used to render markers on the map
*/
